        ...
        if (file.listFiles() != null) {
            ...
            for (int i = 0; i < file.listFiles().length; i++) {
                if (file.listFiles()[i].getName().equals(name)) {
                    ...
                    res.add(file.listFiles()[i]);
                }
                new FS(file.listFiles()[i], 2).search(name);
            }
...
public class Main {
    public static void main(String args[]) throws IOException {
        FS F = new FS(new File("C:\\Users\\К\\Downloads\\lab3_CG.rar\\Lab"), 2);
        System.out.println(new ForkJoinPool().invoke(F));
        F = new FS(new File("C:\\Users\\К\\Downloads\\lab3_CG.rar\\Lab"), 3);
        System.out.println(new ForkJoinPool().invoke(F));
        F = new FS(new File("C:\\Users\\К\\Downloads\\lab3_CG.rar\\Lab"), 4);
        System.out.println(new ForkJoinPool().invoke(F));
        System.out.println(new TreeCreater("C:\\Users\\К\\Downloads\\lab3_CG.rar\\Lab").Do());
       new  Controller().Go();
    }
}
class ForTest {
